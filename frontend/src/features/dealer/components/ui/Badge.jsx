...
const Badge = ({ variant = 'info', children, className = '' }) => {
  const variantClasses = {
    success: 'dark:bg-emerald-500/20 dark:text-emerald-600 dark:border-emerald-500/40 dark:shadow-emerald-500/30 bg-emerald-100 text-emerald-800 border-emerald-400 shadow-emerald-500/20 font-semibold',
    warning: 'dark:bg-yellow-400/20 dark:text-yellow-600 dark:border-yellow-500/40 dark:shadow-yellow-500/30 bg-yellow-100 text-yellow-800 border-yellow-400 shadow-yellow-500/20 font-semibold',
    info: 'dark:bg-blue-500/20 dark:text-blue-600 dark:border-blue-500/40 dark:shadow-blue-500/30 bg-cyan-100 text-cyan-800 border-cyan-400 shadow-cyan-500/20 font-semibold',
