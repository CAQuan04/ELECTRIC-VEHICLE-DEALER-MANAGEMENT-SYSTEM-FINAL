...
const Badge = ({ variant = 'info', children, className = '' }) => {
  const variantClasses = {
    success: 'bg-gradient-to-r from-rose-100 to-rose-50 dark:from-rose-500/20 dark:to-rose-600/10 text-rose-800 dark:text-rose-300 border-rose-400 dark:border-rose-500/40 shadow-lg shadow-rose-500/30 dark:shadow-rose-500/20',
