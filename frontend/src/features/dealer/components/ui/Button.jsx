...
const Button = ({ 
  ...
  const variantClasses = {
    ...
    secondary: 'dark:bg-white/10 dark:hover:bg-white/20 dark:text-gray-200 dark:border-white/20 dark:hover:border-emerald-500/50 bg-sky-50 hover:bg-cyan-100 text-cyan-800 border border-cyan-200 hover:border-cyan-400 hover:shadow-lg',
